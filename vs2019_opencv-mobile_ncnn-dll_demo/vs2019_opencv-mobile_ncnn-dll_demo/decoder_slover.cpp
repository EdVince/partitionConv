...
DecodeSlover::DecodeSlover(int h, int w, void* _PConvolution_layer_creator)
{
	...
	net.register_custom_layer("PConvolution", (ncnn::layer_creator_func)_PConvolution_layer_creator);

	if (h == 512 && w == 512)
		net.load_param("assets/AutoencoderKL-512-512-fp16-opt-partition.param");
	else if (h == 256 && w == 256)
